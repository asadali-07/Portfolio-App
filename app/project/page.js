...
import { FaGithub, FaExternalLinkAlt, FaCode, FaReact, FaNodeJs, FaHtml5, FaCss3, FaBootstrap, FaEye } from 'react-icons/fa';
import { SiMongodb, SiExpress, SiTailwindcss, SiJavascript } from 'react-icons/si';

// Project data with additional fields for tech stack and links
const projects = [
  {
    title: "PassOP",
    description: 'A password manager that securely stores website URLs, usernames, and passwords using MongoDB, Express, and React.',
    link: '/project',
    demoLink: 'https://passop.netlify.app',
    githubLink: 'https://github.com/asadali-07/passop',
    imageUrl: '/Screenshot 2024-09-07 181548.png',
    techStack: ['react', 'express', 'mongodb', 'node']
  },
  {
    title: 'iTask',
    description: 'A todo app with task management capabilities including marking tasks as done and filtering incomplete tasks. Built with Express, MongoDB and React.',
    link: '/project',
    demoLink: 'https://itask.netlify.app',
    githubLink: 'https://github.com/asadali-07/itask',
    imageUrl: '/Screenshot 2024-09-07 181829.png',
    techStack: ['react', 'express', 'mongodb', 'node']
  },
  {
    title: 'Music Player',
    description: 'An interactive music player with playback controls, duration adjustment, and volume control. Built with HTML, CSS, JavaScript, and Bootstrap.',
    link: '/project',
    demoLink: 'https://music-player-demo.netlify.app',
    githubLink: 'https://github.com/asadali-07/music-player',
    imageUrl: '/Screenshot 2024-09-07 182348.png',
    techStack: ['html', 'css', 'javascript', 'bootstrap']
  },
  {
    title: 'iWeather',
    description: 'A weather application that provides forecasts for any city. Built with Tailwind CSS and React, using a weather API for backend data.',
    link: '/project',
    demoLink: 'https://iweather-app.netlify.app',
    githubLink: 'https://github.com/asadali-07/iweather',
    imageUrl: '/Screenshot 2024-09-07 182100.png',
    techStack: ['react', 'tailwind', 'javascript']
  },
  {
    title: 'Simon Game',
    description: 'A memory game that tests pattern recognition skills. Built with HTML, CSS, and JavaScript, demonstrating DOM manipulation concepts.',
    link: '/project',
    demoLink: 'https://simon-memory-game.netlify.app',
    githubLink: 'https://github.com/asadali-07/simon-game',
    imageUrl: '/Screenshot 2024-09-07 182936.png',
    techStack: ['html', 'css', 'javascript']
  },
  {
    title: 'Chat App',
    description: 'A real-time chat application with message editing and deletion capabilities. Built with Express and EJS templates using RESTful API principles.',
    link: '/project',
  ...
  {
    title: 'Social App',
    description: 'A social networking application with user search functionality and detailed profile views. Implements Express RESTful APIs for data handling.',
    link: '/project',
    demoLink: 'https://social-app-demo.netlify.app',
    githubLink: 'https://github.com/asadali-07/social-app',
    imageUrl: '/Screenshot 2024-09-07 215534.png',
    techStack: ['express', 'node', 'javascript', 'mongodb']
  },
  {
    title: 'Hamburger Menu',
    description: 'A CSS-only hamburger menu implementation, showcasing CSS checkbox functionality and absolute positioning techniques.',
    link: '/project',
    demoLink: 'https://hamburger-menu-demo.netlify.app',
    githubLink: 'https://github.com/asadali-07/hamburger-menu',
    imageUrl: '/Screenshot 2024-09-07 182858.png',
    techStack: ['html', 'css']
  },
  {
    title: 'Subscription Cards',
    description: 'A responsive pricing section featuring three membership tiers, styled with Bootstrap for a clean, modern look.',
    link: '/project',
    demoLink: 'https://subscription-cards-demo.netlify.app',
    githubLink: 'https://github.com/asadali-07/subscription-cards',
...
const Project = () => {
  ...
  const techCategories = ['all', ...new Set(projects.flatMap(project => project.techStack))];
    ...
    <div className="min-h-screen py-16 px-4 bg-gradient-to-b from-white/5 to-blue-50/5 dark:from-gray-900/10 dark:to-blue-900/5">
      <div className="container mx-auto max-w-7xl">
        ...
        >
          ...
          >
            Explore my portfolio of web development projects, showcasing my skills and experience across various technologies.
          </motion.p>
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                      <div className="flex gap-3 scale-90 opacity-0 group-hover:scale-100 group-hover:opacity-100 transition-all duration-300">
                        <motion.a 
                          ...
                          className="p-3 bg-gradient-to-r from-blue-500 to-blue-600 rounded-full text-white shadow-lg"
                        ...
                        <motion.a 
                          href={project.link} 
                          className="p-3 bg-gradient-to-r from-purple-500 to-purple-600 rounded-full text-white shadow-lg"
                          whileHover={{ scale: 1.1, rotate: 5 }}
                          whileTap={{ scale: 0.9 }}
                    ...
                    <div className="flex gap-1.5">
                      {project.techStack.slice(0, 3).map(tech => (
                        <motion.div 
                          ...
                          className="tooltip" 
                          data-tip={tech.charAt(0).toUpperCase() + tech.slice(1)}
